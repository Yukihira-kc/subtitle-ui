(function(){
  ...
  function render(el,item,settings){
    ...
    el.replaceChildren();el.style.cssText='box-sizing:content-box;padding:8px;color:white;background:'+settings.keyColor+';font-family:'+CaptionLayout.font+';font-size:'+size+'px;line-height:1.5;width:'+ (columns+.5)+'em;height:'+ (lineCount*1.5)+'em;min-height:0;flex-shrink:0;text-shadow:1px 1px #000;';
